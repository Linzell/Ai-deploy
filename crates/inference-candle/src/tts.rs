...
/// Candle-based TTS task using Parler TTS.
pub struct CandleTtsTask {
    /// Task name.
    name: String,
    /// Parler TTS model (protected by mutex for interior mutability).
...
impl CandleTtsTask {
    ...
    pub fn from_model_dir(
        ...
        let parler_config: ParlerConfig = serde_json::from_reader(
